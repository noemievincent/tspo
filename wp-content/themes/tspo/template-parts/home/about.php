...
<div class="flex flex-col">
	<section aria-labelledby="about" class="about grid grid-cols-12 gap-5 items-center">
		<div class="col-start-2 col-span-10 rl:col-start-2 rl:col-span-4 flex flex-col gap-12 justify-between my-16 rl:my-24">
			<div class="flex flex-col gap-4">
				<h2 id="about"
				    class="text-blue-dark w-fit font-black tracking-wider text-3xl rl:text-4xl"><?= $about_title ?></h2>
				<div class="wysiwyg">
					<?= $desc ?>
				</div>
			</div>
	...
	<?php if ( $values_items ): ?>
		<section aria-labelledby="values" class="values bg-blue-light py-20 rg:py-28 grid grid-cols-12 gap-5 items-center">
			<div class="col-start-2 col-span-10 flex flex-col gap-12 rg:gap-20">
				<h2 id="values"
				    class="text-center text-blue-dark font-black tracking-wider text-3xl rl:text-4xl"><?= $values_title ?></h2>
